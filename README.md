...
**My personal learning path toward becoming a DevOps Engineer and Data Scientist — in one roadmap.**
...
If you're on a similar path, feel free to fork it, star it, or open a discussion. Learning is better together.
...
After the core 8 phases, the path splits into two specializations:
...
👉 The full, detailed checklist for every topic lives in **[`roadmap.md`](./roadmap.md)**.
...
## 🎯 Why DevOps *and* Data Science?

Most roadmaps pick one lane. I'm deliberately combining both because:
- DevOps teaches me **how systems run reliably** — Linux, networking, containers, pipelines.
...
I update this roadmap regularly as I check off new topics. Star ⭐ the repo if you'd like to follow the journey, or open an issue if you have resource recommendations!
